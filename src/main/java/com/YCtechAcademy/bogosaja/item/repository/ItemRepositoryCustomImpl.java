...
import com.YCtechAcademy.bogosaja.item.domain.QItem;
import com.YCtechAcademy.bogosaja.item.domain.QItemImg;
import com.YCtechAcademy.bogosaja.item.dto.ItemSearchDto;
import com.YCtechAcademy.bogosaja.item.dto.MainItemDto;
import com.YCtechAcademy.bogosaja.item.dto.QMainItemDto;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    private BooleanExpression regDtsAfter(String searchDateType) {
        ...
        if (StringUtils.equals("all", searchDateType) || searchDateType == null) {
            return null;
        } else if (StringUtils.equals("all", searchDateType)) {
