...
public class ItemController {
    ...
    public String itemDtl(Model model, @PathVariable("itemId") Long itemId, @AuthenticationPrincipal Member member1)
            throws NotFoundException {
        ItemFormDto itemFormDto = itemService.getItemDtl(itemId);
        itemFormDto.setIsCreatedByMember(Objects.equals(member1.getEmail(), itemFormDto.getCreatedBy()));
